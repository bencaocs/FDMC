...
plt.scatter(y_old, row1[0:29], c='#00B8B8',#c是颜色 marker是形状 alpha是透明度
...
plt.xlabel('Number of marks', fontsize=15)#fontsize字的大小
...
for i in range(len(x_width)):#控制柱的宽度  使两个柱形图并行
...
ax2.set_ylim(0,15)#控制Y轴的范围
ax2.set_xlim(-0.6,29)#控制X轴的范围
plt.xticks(fontsize=15)
plt.yticks(fontsize=15)
plt.legend(loc='upper left', bbox_to_anchor=(0, 0.89), fontsize=15)#显示图例
